...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
     <div>
         <h2><%: Title %></h2>
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="ProjectId" DataSourceID="ProjectsSDS" ShowFooter="True" CssClass="table table-hover">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Name" SortExpression="Name">
                    ...
                    <FooterTemplate>
                        ...
                        <asp:RegularExpressionValidator ControlToValidate="addName" ErrorMessage="Поле 'Name' должно содержать от 5 до 20 букв и цифр" ID="regexpAddName" runat="server" Text="*" ValidationExpression="^[A-Za-z0-9а-яА-Я_-]{5,20}$" ValidationGroup="addGroup"></asp:RegularExpressionValidator>
                    </FooterTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Start date"  SortExpression="StartDate">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox2" runat="server" type="date" Text='<%# Bind("StartDate","{0:dd.MM.yyyy}") %>'></asp:TextBox>
                ...
                <asp:TemplateField HeaderText="End date" SortExpression="EndDate">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox3" type="date" runat="server" Text='<%# Bind("EndDate","{0:dd.MM.yyyy}") %>'></asp:TextBox>
                ...
                <asp:TemplateField HeaderText="Estimated revenue" SortExpression="EstimatedRevenue">
                    ...
                    <FooterTemplate>
                        ...
                        <asp:CompareValidator ControlToValidate="addEstimatedRevenue" ErrorMessage="Заполните поле Estimated Revenue корректно" ID="CompareValidator3" Operator="DataTypeCheck" runat="server"  Text="*" ForeColor="red" Type="Double" ValidationGroup="addGroup"></asp:CompareValidator>
